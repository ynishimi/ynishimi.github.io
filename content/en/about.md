...
*Konnichiwa*! I am **Yuki Nishimi**, a first-year master's student in the Communications and Computer Engineering course at the Graduate School of Informatics, Kyoto University.
As of March 2026, I am having an exchange year at EPFL in Switzerland.
My interest includes how computers in discrete systems can work efficiently/reliably, cooperating with one another.
...
: Working on a full-time research project at the [Distributed Computing Lab (DCL)](https://dcl.epfl.ch/site/), focusing on the design and development of a P2P distribution system for efficient Large Language Model (LLM) deployment.
